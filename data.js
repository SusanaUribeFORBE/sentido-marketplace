...
const BASE_DATA = [
  ...
  { id:5, name:'Monsie', photo:'https://images.unsplash.com/photo-1560859259-fcf2b952aed8?w=800&h=400&fit=crop', city:'Bogotá', formal:'En proceso', tagline:'Ropa infantil económica y de calidad, apoyando a jóvenes que estudian en Bogotá.', seals:'Jefatura de Hogar', impact:'Apoya estudiantes de diseño y ofrece ropa infantil a precio accesible para familias colombianas.', whatsapp:'573005234565', products:[{name:'Oversize Niño',price:'$32.000 al por mayor',rawPrice:'32000'},{name:'Conjunto Niña Ángel',price:'$28.000 al por mayor',rawPrice:'28000'},{name:'Conjunto Oversize Cuello Redondo',price:'$30.000 al por mayor',rawPrice:'30000'}]},
